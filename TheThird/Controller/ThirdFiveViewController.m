//
//  ThirdFiveViewController.m
//  iNews
//
//  Created by 顾鸿飞 on 14-9-4.
//  Copyright (c) 2014年 test. All rights reserved.
//

#import "ThirdFiveViewController.h"

@interface ThirdFiveViewController ()
...
@implementation ThirdFiveViewController
...
- (void)viewDidLoad
{
    ...
    UIWebView *webView = [[UIWebView alloc] initWithFrame:CGRectMake(0, -66, self.view.frame.size.width, self.view.frame.size.height + 144)];
...
- (void)collect:(UIButton *)button{
    ...
    if (han.result == 19) {
        ...
        UIAlertView *alert = [[UIAlertView alloc]initWithTitle:@"已收藏成功" message:@"请勿重复收藏" delegate:self cancelButtonTitle:nil otherButtonTitles:@"确定", nil];
      ...
      UIAlertView *alert = [[UIAlertView alloc]initWithTitle:@"收藏成功" message:nil delegate:self cancelButtonTitle:nil otherButtonTitles:@"确定", nil];
