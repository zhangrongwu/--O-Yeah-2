...
@implementation MyThreeCollectionViewCell
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _myLabel1.backgroundColor = [UIColor whiteColor];
        ...
        _myLabel2.backgroundColor = [UIColor whiteColor];
        ...
        _myLabel3.backgroundColor = [UIColor whiteColor];
        ...
        _myLabel4.backgroundColor = [UIColor whiteColor];
        ...
        _myLabel5.backgroundColor = [UIColor whiteColor];
        ...
        _myLabel6.backgroundColor = [UIColor whiteColor];
        ...
        _myLabel7.backgroundColor = [UIColor whiteColor];
        ...
        _myLabel8.backgroundColor = [UIColor whiteColor];
        ...
        _myLabel9.backgroundColor = [UIColor whiteColor];
        ...
        _myLabel10.backgroundColor = [UIColor whiteColor];
...
-(void)layoutSubviews
{
    ...
    _myImageView.frame = CGRectMake(0, y*1/5, x, y*2/5);
    _myLabel.frame = CGRectMake(0, y*2/5-20, x, 20);
    
    
    _myLabel1.frame = CGRectMake(0, 0, x/2+ 0.5, y*1/5);
    _myLabel2.frame = CGRectMake(0, y*1/5-20, x/2+ 0.5, 20);
    
    _myLabel3.frame = CGRectMake(x/2+1, 0, x/2+ 0.5, y*1/5);
    _myLabel4.frame = CGRectMake(0, y*1/5-20, x/2+ 0.5, 20);
    
    _myLabel5.frame = CGRectMake(0, y*3/5, x/2+ 0.5, y*1/5);
    _myLabel6.frame = CGRectMake(0, y*1/5-20, x/2+ 0.5, 20);
    
    _myLabel7.frame = CGRectMake(x/2+1, y*3/5, x/2+ 0.5, y*1/5);
